...
% [~, sheetNames] = xlsfinfo('Findex 4k.xlsx'); % findex 4k
% [~, sheetNames] = xlsfinfo('Findex 8k 1lag.xlsx'); % findex 8k 1lag
% [~, sheetNames] = xlsfinfo('Findex 8k 2lag.xlsx'); % findex 8k 2lag
[~, sheetNames] = xlsfinfo('Findex 10k 4lag.xlsx'); % findex 8k 4lag
numVars = length(sheetNames);  % Número de variables


% Leer la primera hoja como celda para obtener etiquetas de tiempo reales
raw = readcell('Findex 10k 4lag.xlsx', 'Sheet', sheetNames{1});
...
for i = 1:numVars
    data = readmatrix('Findex 10k 4lag.xlsx', 'Sheet', sheetNames{i});
...
for i = 1:numVars
    ...
    % outputDir = fullfile(pwd, '8K_1lag');  % Carpeta 8k 1lag
    % outputDir = fullfile(pwd, '8K_2lag');  % Carpeta 8k 2lag
