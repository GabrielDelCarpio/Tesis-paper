...
% [~, sheetNames] = xlsfinfo('Profundidad.xlsx'); % 4k
% [~, sheetNames] = xlsfinfo('Profundidad 8k 1lag.xlsx'); % 8k 1lag
% [~, sheetNames] = xlsfinfo('Profundidad 8k 2lag.xlsx'); % 8k 2lag
[~, sheetNames] = xlsfinfo('Profundidad 10k 4lag.xlsx'); % 8k 4lag
numVars = length(sheetNames);  % Número de variables

% Leer la primera hoja como celda para obtener etiquetas de tiempo reales
raw = readcell('Profundidad 10k 4lag.xlsx', 'Sheet', sheetNames{1});
...
for i = 1:numVars
    data = readmatrix('Profundidad 10k 4lag.xlsx', 'Sheet', sheetNames{i});
